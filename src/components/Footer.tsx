...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer id="contact" className="bg-emerald-950 text-slate-200 border-t border-emerald-800/80 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-emerald-800/60">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-slate-200 text-xs sm:text-sm leading-relaxed mt-3 font-normal">
            ...
            <div className="flex items-center gap-3 pt-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-lg bg-emerald-900 hover:bg-emerald-800 text-white flex items-center justify-center transition border border-emerald-600/70"
                aria-label="Facebook"
              >
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm text-slate-200 font-medium">
              ...
              <li>
                <Link to="/appointment" className="hover:text-amber-300 transition-colors">অনলাইন সিরিয়াল নিন</Link>
              </li>
              <li>
                <Link to="/articles" className="hover:text-amber-300 transition-colors">স্বাস্থ্য সচেতনতা ও নিবন্ধ</Link>
              </li>
              <li>
                <Link to="/contact" className="hover:text-amber-300 transition-colors">যোগাযোগ ও ঠিকানা</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            {chambers.map((c) => (
              <div key={c.id} className="bg-emerald-900/60 border border-emerald-700/80 rounded-xl p-3 text-xs shadow-sm">
                <p className="font-bold text-white text-sm">{c.nameBn}</p>
                <p className="text-slate-200 mt-1 leading-snug">{c.addressBn}</p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-300">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={onOpenLogin}
              className="text-xs text-slate-300 hover:text-white transition underline cursor-pointer font-medium"
            >
